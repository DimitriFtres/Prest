package be.prest.Controller.NewsRestaurant;
...
public class NewsRestaurantController {
    ...
    public ApiResponse detailForRestaurant(@PathVariable int restaurant_id) {
        ...
        return new ApiResponse(true, newsRestaurantRepository.findAllByRestaurantAndActif(restaurantRepository.findById(restaurant_id), true), BASE_CODE + "detail.success");
    }
